...
export function GameStartup({children}:{children:ReactNode}){
 ...
 return <section className="game-startup" data-lobby-period={lobbyPeriod} aria-label="Chargement de Paw & Claw" aria-live="polite">
   <GameAsset assetId={lobbyAssetId(lobbyPeriod)} className="game-startup-bg" decorative loading="eager"/>
